...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname Naturals-and-Helpers-Design-Quiz-solution) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
(define (sink lob)
  (cond [(empty? lob) empty]
        [(empty? (rest lob)) lob]
        [else (helper (first lob) (rest lob))]))
